...
alert(`Thank you for choosing our restaurant, ${userName}! We're here to make your experience memorable.`)


// Step 2 - What type of food

// Added while loops to check if the user's input is not one of the valid options by using === (equals)
...
// `Thank you ${name}, you have ordered an adult portion.`
...
//  `Thank you ${name}, you have ordered a child portion.`
// )   
