...
if (chosenFoodType == `pizza`) {
  subtype = prompt (`What type of pizza would you like to order?
  Please enter a number: 
  1. Calzone
  2. Vezuvio
  3. Hawaii`);
  ...
  subtype = prompt (`What type of pasta would you like to order?
  Please enter a number: 
  1. Bolognese
  2. Carbonara
  3. Vegetarian`);
  ...
  subtype = prompt (`What type of salad would you like to order?
  Please enter a number: 
  1. Ceasar salad 
  2. Kebab salad 
  3. Greek salad`);
