...
alert(`Welcome to Hungry Hugo's! Ready to Start? - Click 'OK' to begin.`);
...
if (confirmation === "1") {
  alert(
    `Your ${lastChoice} is being prepared! Thank you for ordering food from Hungry Hugo's Pizzeria!`
  );
