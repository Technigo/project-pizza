...
//let(orderConfimation === "1") ? alert(`Thank you ${userName} for placing your order!  Please wait while your food is being prepared (approx. 20min).  Hope to see you again!`) : alert(`No worries!  Come back anytime to try our menu!`);
