...
alert(`Welcome to Nathalie's JavaScript Pizzeria. Ready to Start? - Click 'OK' to begin.`);
...
let price;
const age = parseInt(prompt(`Before we wrap up your order, we need to know how old you are. 
...
switch (orderConfirmation) {
  ...
  case `no`:
    ...
    break;
  default:
    alert(`Your order will automatically processed. Thank you for your visit.`);
    break;
    Process.exit(1);
}
}
